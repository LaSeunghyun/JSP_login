	...
	function likebtn(){
		...
		xhr.onreadystatechange = function(){
			if(xhr.readyState == XMLHttpRequest.DONE && xhr.status == 200){
				document.getElementById('likebtn').innerHTML = xhr.responseText;
			}
		}
	}
</script>
...
<body>
	...
	<table border="1" width="800">
		...
		<tr>
			<td colspan="2">
			<input type="button" value="수정"> | <input type="button" value="삭제"> | <input type="button" value="좋아요" id="likebtn" onclick="likebtn()"> | <input type="button" value="리스트" onclick="location.href='./list.jsp'">
		</tr>
	</table>
</body>
</html>
